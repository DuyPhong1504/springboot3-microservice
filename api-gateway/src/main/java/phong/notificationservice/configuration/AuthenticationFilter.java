package phong.notificationservice.configuration;
...
import phong.notificationservice.service.IdentityService;
...
public class AuthenticationFilter implements GlobalFilter, Ordered {
    ...
    @NonFinal
    private String[] PUBLIC_ENDPOINTS = {"/identity/auth/.*", "/identity/users/create"};
